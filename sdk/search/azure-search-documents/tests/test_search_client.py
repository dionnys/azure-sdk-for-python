...
class TestSearchClient(object):
    ...
    @mock.patch(
        "azure.search.documents._generated.operations._operations.DocumentsOperations.count"
    )
    ...
    @mock.patch(
        "azure.search.documents._generated.operations._operations.DocumentsOperations.get"
    )
    ...
    @mock.patch(
        "azure.search.documents._generated.operations._operations.DocumentsOperations.search_post"
    )
    ...
    @mock.patch(
        "azure.search.documents._generated.operations._operations.DocumentsOperations.suggest_post"
    )
    ...
    @mock.patch(
        "azure.search.documents._generated.operations._operations.DocumentsOperations.index"
    )
