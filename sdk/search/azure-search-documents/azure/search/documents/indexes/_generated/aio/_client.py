...
class SearchServiceClient(
    ...
    :vartype data_sources: search_service_client.aio.operations.DataSourcesOperations
    :ivar indexers: IndexersOperations operations
    :vartype indexers: search_service_client.aio.operations.IndexersOperations
    :ivar skillsets: SkillsetsOperations operations
    :vartype skillsets: search_service_client.aio.operations.SkillsetsOperations
