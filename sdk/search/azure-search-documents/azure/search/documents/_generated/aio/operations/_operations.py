...
class DocumentsOperations:
    ...
    async def count(self, *, x_ms_client_request_id: Optional[str] = None, **kwargs: Any) -> int:
    ...
    @distributed_trace_async
    async def index(
        self, batch: Union[JSON, IO], *, x_ms_client_request_id: Optional[str] = None, **kwargs: Any
    ) -> JSON:
        """Sends a batch of document write actions to the index.
