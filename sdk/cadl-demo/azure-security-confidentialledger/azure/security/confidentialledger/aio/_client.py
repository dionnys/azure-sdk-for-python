...
class ConfidentialLedgerService:  # pylint: disable=client-accepts-api-version-keyword
    """Service client

    :ivar confidential_ledger: ConfidentialLedger operations
    :vartype confidential_ledger:
     azure.security.confidentialledger.aio.operations.ConfidentialLedger
    ...
    :vartype confidential_ledger_identity_service:
     azure.security.confidentialledger.aio.operations.ConfidentialLedgerIdentityService
    ...
    async def __aenter__(self) -> "ConfidentialLedgerService":
